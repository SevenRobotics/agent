...
func (rg RosMsgGenerator) Namers(*Context) namer.NameSystems      { return nil }
...
func (rg RosMsgGenerator) GenerateType(*Context, io.Writer) error { return nil }
func (rg RosMsgGenerator) Filename() string                       { return rg.OutputFilename }
