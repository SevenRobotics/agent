...
import (
	...
	gengo_seven_robotics_msgs "go_agent/telemetry/gengo/ros/seven_robotics_msgs"
	...
	proto_seven_robotics_msgs "go_agent/telemetry/genproto/ros/seven_robotics_msgs"
...
func ConvertRebootSM(rosMsg gengo_seven_robotics_msgs.RebootSM) (proto_seven_robotics_msgs.RebootSM, error) {

	ret := proto_seven_robotics_msgs.RebootSM{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert RebootSM, msg is nil")
	//}
	...
	ret.RebootMotor = rosMsg.RebootMotor

	ret.RebootPC = rosMsg.RebootPC

	ret.RebootIMX6 = rosMsg.RebootIMX6

	ret.RebootUC = rosMsg.RebootUC

	ret.RebootLAN = rosMsg.RebootLAN

	ret.Rebootv24 = rosMsg.Rebootv24

	ret.RebootSICK = rosMsg.RebootSICK

	ret.RebootPowerExtension = rosMsg.RebootPowerExtension

	return ret, nil
}

func ConvertBLDCState(rosMsg gengo_seven_robotics_msgs.BLDCState) (proto_seven_robotics_msgs.BLDCState, error) {

	ret := proto_seven_robotics_msgs.BLDCState{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert BLDCState, msg is nil")
	//}

	ret.State = uint32(rosMsg.State)

	ret.HaltState = uint32(rosMsg.HaltState)

	return ret, nil
}

func ConvertBrake(rosMsg gengo_seven_robotics_msgs.Brake) (proto_seven_robotics_msgs.Brake, error) {

	ret := proto_seven_robotics_msgs.Brake{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert Brake, msg is nil")
	//}
	...
	ret.Brake = rosMsg.Brake

	return ret, nil
}

func ConvertMotorEmergencyStop(rosMsg gengo_seven_robotics_msgs.MotorEmergencyStop) (proto_seven_robotics_msgs.MotorEmergencyStop, error) {

	ret := proto_seven_robotics_msgs.MotorEmergencyStop{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert MotorEmergencyStop, msg is nil")
	//}
	...
	ret.StateON = rosMsg.StateON

	return ret, nil
}

func ConvertPIDStats(rosMsg gengo_seven_robotics_msgs.PIDStats) (proto_seven_robotics_msgs.PIDStats, error) {

	ret := proto_seven_robotics_msgs.PIDStats{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert PIDStats, msg is nil")
	//}

	ret.RightError = rosMsg.RightError

	ret.LeftError = rosMsg.LeftError

	ret.RightIntegralError = rosMsg.RightIntegralError

	ret.LeftIntegralError = rosMsg.LeftIntegralError

	ret.RightOutput = rosMsg.RightOutput

	ret.LeftOutput = rosMsg.LeftOutput

	return ret, nil
}

func ConvertEgoVelocity(rosMsg gengo_seven_robotics_msgs.EgoVelocity) (proto_seven_robotics_msgs.EgoVelocity, error) {

	ret := proto_seven_robotics_msgs.EgoVelocity{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert EgoVelocity, msg is nil")
	//}
	...
	t1, err := ConvertTwist(rosMsg.Velocity)
	ret.Velocity = &t1
...
func ConvertMotorControlState(rosMsg gengo_seven_robotics_msgs.MotorControlState) (proto_seven_robotics_msgs.MotorControlState, error) {

	ret := proto_seven_robotics_msgs.MotorControlState{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert MotorControlState, msg is nil")
	//}

	ret.StateId = uint32(rosMsg.StateId)

	ret.StateName = rosMsg.StateName

	return ret, nil
}

func ConvertMotorCurrent(rosMsg gengo_seven_robotics_msgs.MotorCurrent) (proto_seven_robotics_msgs.MotorCurrent, error) {

	ret := proto_seven_robotics_msgs.MotorCurrent{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert MotorCurrent, msg is nil")
	//}

	ret.RightMotorCurrent = rosMsg.RightMotorCurrent

	ret.LeftMotorCurrent = rosMsg.LeftMotorCurrent

	return ret, nil
}

func ConvertMotorEncoder(rosMsg gengo_seven_robotics_msgs.MotorEncoder) (proto_seven_robotics_msgs.MotorEncoder, error) {

	ret := proto_seven_robotics_msgs.MotorEncoder{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert MotorEncoder, msg is nil")
	//}

	ret.EncoderID = uint32(rosMsg.EncoderID)

	ret.Ticks = uint32(rosMsg.Ticks)

	ret.TotalCount = rosMsg.TotalCount

	ret.TickHz = rosMsg.TickHz

	return ret, nil
}

func ConvertBLEControllerStatus(rosMsg gengo_seven_robotics_msgs.BLEControllerStatus) (proto_seven_robotics_msgs.BLEControllerStatus, error) {

	ret := proto_seven_robotics_msgs.BLEControllerStatus{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert BLEControllerStatus, msg is nil")
	//}
...
func ConvertDistance(rosMsg gengo_seven_robotics_msgs.Distance) (proto_seven_robotics_msgs.Distance, error) {

	ret := proto_seven_robotics_msgs.Distance{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert Distance, msg is nil")
	//}

	ret.ObjectId = uint32(rosMsg.ObjectId)

	ret.Distance = rosMsg.Distance

	return ret, nil
}

func ConvertMotorRPM(rosMsg gengo_seven_robotics_msgs.MotorRPM) (proto_seven_robotics_msgs.MotorRPM, error) {

	ret := proto_seven_robotics_msgs.MotorRPM{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert MotorRPM, msg is nil")
	//}

	ret.Rpm = int32(rosMsg.Rpm)

	return ret, nil
}

func ConvertMotorVelocity(rosMsg gengo_seven_robotics_msgs.MotorVelocity) (proto_seven_robotics_msgs.MotorVelocity, error) {

	ret := proto_seven_robotics_msgs.MotorVelocity{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert MotorVelocity, msg is nil")
	//}

	ret.Velocity = rosMsg.Velocity

	return ret, nil
}

func ConvertBLDCMotorState(rosMsg gengo_seven_robotics_msgs.BLDCMotorState) (proto_seven_robotics_msgs.BLDCMotorState, error) {

	ret := proto_seven_robotics_msgs.BLDCMotorState{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert BLDCMotorState, msg is nil")
	//}
	...
	ret.IdTarget = rosMsg.IdTarget

	ret.IqTarget = rosMsg.IqTarget

	ret.IqErDt = rosMsg.IqErDt

	ret.Phase = rosMsg.Phase

	ret.RpmMeasured = rosMsg.RpmMeasured

	ret.RpmCommanded = rosMsg.RpmCommanded

	ret.IAlpha = rosMsg.IAlpha

	ret.IBeta = rosMsg.IBeta

	ret.IAbs = rosMsg.IAbs

	ret.VAlpha = rosMsg.VAlpha

	ret.VBeta = rosMsg.VBeta
	...
	ret.Duty = rosMsg.Duty

	ret.EncoderOffset = rosMsg.EncoderOffset

	ret.SpeedRads = rosMsg.SpeedRads

	ret.MechanicalPhase = rosMsg.MechanicalPhase

	ret.MotorID = uint32(rosMsg.MotorID)

	return ret, nil
}

func ConvertBatteryHealth(rosMsg gengo_seven_robotics_msgs.BatteryHealth) (proto_seven_robotics_msgs.BatteryHealth, error) {

	ret := proto_seven_robotics_msgs.BatteryHealth{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert BatteryHealth, msg is nil")
	//}

	ret.Health = uint32(rosMsg.Health)

	return ret, nil
}

func ConvertObstacleVelocity(rosMsg gengo_seven_robotics_msgs.ObstacleVelocity) (proto_seven_robotics_msgs.ObstacleVelocity, error) {

	ret := proto_seven_robotics_msgs.ObstacleVelocity{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert ObstacleVelocity, msg is nil")
	//}
	...
	t2, err := ConvertTwist(rosMsg.RelativeVelocity)
	ret.RelativeVelocity = &t2
...
func ConvertCanAlive(rosMsg gengo_seven_robotics_msgs.CanAlive) (proto_seven_robotics_msgs.CanAlive, error) {

	ret := proto_seven_robotics_msgs.CanAlive{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert CanAlive, msg is nil")
	//}
	...
	ret.NodeID = uint32(rosMsg.NodeID)

	return ret, nil
}

func ConvertMotorPlantFeedback(rosMsg gengo_seven_robotics_msgs.MotorPlantFeedback) (proto_seven_robotics_msgs.MotorPlantFeedback, error) {

	ret := proto_seven_robotics_msgs.MotorPlantFeedback{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert MotorPlantFeedback, msg is nil")
	//}

	ret.SetPointRight = rosMsg.SetPointRight

	ret.SetPointLeft = rosMsg.SetPointLeft

	ret.MeasuredSetPointRight = rosMsg.MeasuredSetPointRight

	ret.MeasuredSetPointLeft = rosMsg.MeasuredSetPointLeft

	ret.SetPointRPMRight = int32(rosMsg.SetPointRPMRight)

	ret.SetPointRPMLeft = int32(rosMsg.SetPointRPMLeft)

	ret.MeasuredRPMRight = int32(rosMsg.MeasuredRPMRight)

	ret.MeasuredRPMLeft = int32(rosMsg.MeasuredRPMLeft)

	return ret, nil
}

func ConvertObstaclePose(rosMsg gengo_seven_robotics_msgs.ObstaclePose) (proto_seven_robotics_msgs.ObstaclePose, error) {

	ret := proto_seven_robotics_msgs.ObstaclePose{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert ObstaclePose, msg is nil")
	//}
	...
	t2, err := ConvertPose(rosMsg.Position)
	ret.Position = &t2
...
func ConvertSlidingWindowPoses(rosMsg gengo_seven_robotics_msgs.SlidingWindowPoses) (proto_seven_robotics_msgs.SlidingWindowPoses, error) {

	ret := proto_seven_robotics_msgs.SlidingWindowPoses{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert SlidingWindowPoses, msg is nil")
	//}

	var err error

	for _, m := range rosMsg.TargetPoses {
		c, err := ConvertPoseStamped(m)
		if err != nil {
			return ret, err
		}
		ret.TargetPoses = append(ret.TargetPoses, &c)
	}
...
func ConvertLed(rosMsg gengo_seven_robotics_msgs.Led) (proto_seven_robotics_msgs.Led, error) {

	ret := proto_seven_robotics_msgs.Led{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert Led, msg is nil")
	//}
	...
	t1, err := ConvertColorRGBA(rosMsg.Colors)
	ret.Colors = &t1
	...
	ret.Effect = uint32(rosMsg.Effect)

	return ret, nil
}

func ConvertLineSegment(rosMsg gengo_seven_robotics_msgs.LineSegment) (proto_seven_robotics_msgs.LineSegment, error) {

	ret := proto_seven_robotics_msgs.LineSegment{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert LineSegment, msg is nil")
	//}
	...
	t2 := make([]float32, 0, len(rosMsg.Covariance))
	for _, m := range rosMsg.Covariance {
		t2 = append(t2, m)
	}

	ret.Covariance = append(ret.Covariance, t2...)

	t3 := make([]float32, 0, len(rosMsg.Start))
	for _, m := range rosMsg.Start {
		t3 = append(t3, m)
	}

	ret.Start = append(ret.Start, t3...)

	t4 := make([]float32, 0, len(rosMsg.End))
	for _, m := range rosMsg.End {
		t4 = append(t4, m)
	}

	ret.End = append(ret.End, t4...)

	return ret, nil
}

func ConvertLineSegmentList(rosMsg gengo_seven_robotics_msgs.LineSegmentList) (proto_seven_robotics_msgs.LineSegmentList, error) {

	ret := proto_seven_robotics_msgs.LineSegmentList{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert LineSegmentList, msg is nil")
	//}
	...
	for _, m := range rosMsg.LineSegments {
		c, err := ConvertLineSegment(m)
		if err != nil {
			return ret, err
		}
		ret.LineSegments = append(ret.LineSegments, &c)
	}
...
func ConvertPowerStatus(rosMsg gengo_seven_robotics_msgs.PowerStatus) (proto_seven_robotics_msgs.PowerStatus, error) {

	ret := proto_seven_robotics_msgs.PowerStatus{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert PowerStatus, msg is nil")
	//}
	...
	ret.MotorON = rosMsg.MotorON

	ret.PcON = rosMsg.PcON

	ret.Imx6ON = rosMsg.Imx6ON

	ret.UcON = rosMsg.UcON

	ret.LanON = rosMsg.LanON

	ret.KinectON = rosMsg.KinectON

	ret.SickON = rosMsg.SickON

	ret.AuxON = rosMsg.AuxON

	return ret, nil
}

func ConvertAdisImu(rosMsg gengo_seven_robotics_msgs.AdisImu) (proto_seven_robotics_msgs.AdisImu, error) {

	ret := proto_seven_robotics_msgs.AdisImu{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert AdisImu, msg is nil")
	//}
	...
	t1 := make([]float32, 0, len(rosMsg.GyroLatest))
	for _, m := range rosMsg.GyroLatest {
		t1 = append(t1, m)
	}

	ret.GyroLatest = append(ret.GyroLatest, t1...)

	t2 := make([]float32, 0, len(rosMsg.AccelLatest))
	for _, m := range rosMsg.AccelLatest {
		t2 = append(t2, m)
	}

	ret.AccelLatest = append(ret.AccelLatest, t2...)

	return ret, nil
}

func ConvertBatteryType(rosMsg gengo_seven_robotics_msgs.BatteryType) (proto_seven_robotics_msgs.BatteryType, error) {

	ret := proto_seven_robotics_msgs.BatteryType{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert BatteryType, msg is nil")
	//}

	ret.BatteryChemistry = rosMsg.BatteryChemistry

	return ret, nil
}

func ConvertPowerManagement(rosMsg gengo_seven_robotics_msgs.PowerManagement) (proto_seven_robotics_msgs.PowerManagement, error) {

	ret := proto_seven_robotics_msgs.PowerManagement{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert PowerManagement, msg is nil")
	//}
	...
	ret.LaserEnable = rosMsg.LaserEnable

	ret.LaserTime = rosMsg.LaserTime

	ret.LaserCycle = uint32(rosMsg.LaserCycle)

	ret.KinectEnabled = rosMsg.KinectEnabled

	ret.KinectTime = rosMsg.KinectTime

	ret.KinectCycle = uint32(rosMsg.KinectCycle)

	ret.MotorEnable = rosMsg.MotorEnable

	ret.MotorTime = rosMsg.MotorTime

	ret.MotorCycle = uint32(rosMsg.MotorCycle)

	ret.Stm32Enable = rosMsg.Stm32Enable

	ret.Stm32Time = rosMsg.Stm32Time

	ret.Stm32Cycle = uint32(rosMsg.Stm32Cycle)

	ret.Imx6Enable = rosMsg.Imx6Enable

	ret.Imx6Time = rosMsg.Imx6Time

	ret.Imx6Cycle = uint32(rosMsg.Imx6Cycle)

	ret.LanEnable = rosMsg.LanEnable

	ret.LanTime = rosMsg.LanTime

	ret.LanCycle = uint32(rosMsg.LanCycle)

	ret.PcEnable = rosMsg.PcEnable

	ret.PcTime = rosMsg.PcTime

	ret.PcCycle = uint32(rosMsg.PcCycle)

	return ret, nil
}

func ConvertBattery(rosMsg gengo_seven_robotics_msgs.Battery) (proto_seven_robotics_msgs.Battery, error) {

	ret := proto_seven_robotics_msgs.Battery{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert Battery, msg is nil")
	//}
	...
	ret.Charging = rosMsg.Charging

	ret.CapacityDesigned = rosMsg.CapacityDesigned

	ret.CapacityFull = rosMsg.CapacityFull

	ret.NCells = uint32(rosMsg.NCells)

	ret.Volts = rosMsg.Volts

	ret.Amps = rosMsg.Amps

	ret.TempC = rosMsg.TempC

	ret.RemainingTime = rosMsg.RemainingTime

	ret.RemainingCapacity = rosMsg.RemainingCapacity
...
func ConvertObstacleRadius(rosMsg gengo_seven_robotics_msgs.ObstacleRadius) (proto_seven_robotics_msgs.ObstacleRadius, error) {

	ret := proto_seven_robotics_msgs.ObstacleRadius{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert ObstacleRadius, msg is nil")
	//}
...
func ConvertRPMError(rosMsg gengo_seven_robotics_msgs.RPMError) (proto_seven_robotics_msgs.RPMError, error) {

	ret := proto_seven_robotics_msgs.RPMError{}

	//if rosMsg == nil {
	//  return ret, fmt.Errorf("Cannot not convert RPMError, msg is nil")
	//}
...
func SerializeRebootSM(msg proto_seven_robotics_msgs.RebootSM) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeBLDCState(msg proto_seven_robotics_msgs.BLDCState) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeBrake(msg proto_seven_robotics_msgs.Brake) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeMotorEmergencyStop(msg proto_seven_robotics_msgs.MotorEmergencyStop) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializePIDStats(msg proto_seven_robotics_msgs.PIDStats) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeEgoVelocity(msg proto_seven_robotics_msgs.EgoVelocity) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeMotorControlState(msg proto_seven_robotics_msgs.MotorControlState) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeMotorCurrent(msg proto_seven_robotics_msgs.MotorCurrent) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeMotorEncoder(msg proto_seven_robotics_msgs.MotorEncoder) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeBLEControllerStatus(msg proto_seven_robotics_msgs.BLEControllerStatus) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeDistance(msg proto_seven_robotics_msgs.Distance) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeMotorRPM(msg proto_seven_robotics_msgs.MotorRPM) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeMotorVelocity(msg proto_seven_robotics_msgs.MotorVelocity) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeBLDCMotorState(msg proto_seven_robotics_msgs.BLDCMotorState) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeBatteryHealth(msg proto_seven_robotics_msgs.BatteryHealth) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeObstacleVelocity(msg proto_seven_robotics_msgs.ObstacleVelocity) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeCanAlive(msg proto_seven_robotics_msgs.CanAlive) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeMotorPlantFeedback(msg proto_seven_robotics_msgs.MotorPlantFeedback) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeObstaclePose(msg proto_seven_robotics_msgs.ObstaclePose) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeSlidingWindowPoses(msg proto_seven_robotics_msgs.SlidingWindowPoses) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeLed(msg proto_seven_robotics_msgs.Led) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeLineSegment(msg proto_seven_robotics_msgs.LineSegment) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeLineSegmentList(msg proto_seven_robotics_msgs.LineSegmentList) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializePowerStatus(msg proto_seven_robotics_msgs.PowerStatus) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeAdisImu(msg proto_seven_robotics_msgs.AdisImu) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeBatteryType(msg proto_seven_robotics_msgs.BatteryType) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializePowerManagement(msg proto_seven_robotics_msgs.PowerManagement) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeBattery(msg proto_seven_robotics_msgs.Battery) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeObstacleRadius(msg proto_seven_robotics_msgs.ObstacleRadius) ([]byte, error) {
	return proto.Marshal(&msg)
}

func SerializeRPMError(msg proto_seven_robotics_msgs.RPMError) ([]byte, error) {
	return proto.Marshal(&msg)
}
...
func GetBuilderFromName(name string) (iface.Builder, error) {
	...
	case "RebootSM":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.RebootSM, proto_seven_robotics_msgs.RebootSM]{
			MsgConverter: ConvertRebootSM,
			Serializer:   SerializeRebootSM,
		}, nil
	case "BLDCState":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.BLDCState, proto_seven_robotics_msgs.BLDCState]{
			MsgConverter: ConvertBLDCState,
			Serializer:   SerializeBLDCState,
		}, nil
	case "Brake":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.Brake, proto_seven_robotics_msgs.Brake]{
			MsgConverter: ConvertBrake,
			Serializer:   SerializeBrake,
		}, nil
	case "MotorEmergencyStop":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.MotorEmergencyStop, proto_seven_robotics_msgs.MotorEmergencyStop]{
			MsgConverter: ConvertMotorEmergencyStop,
			Serializer:   SerializeMotorEmergencyStop,
		}, nil
	case "PIDStats":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.PIDStats, proto_seven_robotics_msgs.PIDStats]{
			MsgConverter: ConvertPIDStats,
			Serializer:   SerializePIDStats,
		}, nil
	case "EgoVelocity":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.EgoVelocity, proto_seven_robotics_msgs.EgoVelocity]{
			MsgConverter: ConvertEgoVelocity,
			Serializer:   SerializeEgoVelocity,
		}, nil
	case "MotorControlState":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.MotorControlState, proto_seven_robotics_msgs.MotorControlState]{
			MsgConverter: ConvertMotorControlState,
			Serializer:   SerializeMotorControlState,
		}, nil
	case "MotorCurrent":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.MotorCurrent, proto_seven_robotics_msgs.MotorCurrent]{
			MsgConverter: ConvertMotorCurrent,
			Serializer:   SerializeMotorCurrent,
		}, nil
	case "MotorEncoder":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.MotorEncoder, proto_seven_robotics_msgs.MotorEncoder]{
			MsgConverter: ConvertMotorEncoder,
			Serializer:   SerializeMotorEncoder,
		}, nil
	case "BLEControllerStatus":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.BLEControllerStatus, proto_seven_robotics_msgs.BLEControllerStatus]{
			MsgConverter: ConvertBLEControllerStatus,
			Serializer:   SerializeBLEControllerStatus,
		}, nil
	case "Distance":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.Distance, proto_seven_robotics_msgs.Distance]{
			MsgConverter: ConvertDistance,
			Serializer:   SerializeDistance,
		}, nil
	case "MotorRPM":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.MotorRPM, proto_seven_robotics_msgs.MotorRPM]{
			MsgConverter: ConvertMotorRPM,
			Serializer:   SerializeMotorRPM,
		}, nil
	case "MotorVelocity":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.MotorVelocity, proto_seven_robotics_msgs.MotorVelocity]{
			MsgConverter: ConvertMotorVelocity,
			Serializer:   SerializeMotorVelocity,
		}, nil
	case "BLDCMotorState":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.BLDCMotorState, proto_seven_robotics_msgs.BLDCMotorState]{
			MsgConverter: ConvertBLDCMotorState,
			Serializer:   SerializeBLDCMotorState,
		}, nil
	case "BatteryHealth":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.BatteryHealth, proto_seven_robotics_msgs.BatteryHealth]{
			MsgConverter: ConvertBatteryHealth,
			Serializer:   SerializeBatteryHealth,
		}, nil
	case "ObstacleVelocity":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.ObstacleVelocity, proto_seven_robotics_msgs.ObstacleVelocity]{
			MsgConverter: ConvertObstacleVelocity,
			Serializer:   SerializeObstacleVelocity,
		}, nil
	case "CanAlive":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.CanAlive, proto_seven_robotics_msgs.CanAlive]{
			MsgConverter: ConvertCanAlive,
			Serializer:   SerializeCanAlive,
		}, nil
	case "MotorPlantFeedback":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.MotorPlantFeedback, proto_seven_robotics_msgs.MotorPlantFeedback]{
			MsgConverter: ConvertMotorPlantFeedback,
			Serializer:   SerializeMotorPlantFeedback,
		}, nil
	case "ObstaclePose":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.ObstaclePose, proto_seven_robotics_msgs.ObstaclePose]{
			MsgConverter: ConvertObstaclePose,
			Serializer:   SerializeObstaclePose,
		}, nil
	case "SlidingWindowPoses":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.SlidingWindowPoses, proto_seven_robotics_msgs.SlidingWindowPoses]{
			MsgConverter: ConvertSlidingWindowPoses,
			Serializer:   SerializeSlidingWindowPoses,
		}, nil
	case "Led":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.Led, proto_seven_robotics_msgs.Led]{
			MsgConverter: ConvertLed,
			Serializer:   SerializeLed,
		}, nil
	case "LineSegment":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.LineSegment, proto_seven_robotics_msgs.LineSegment]{
			MsgConverter: ConvertLineSegment,
			Serializer:   SerializeLineSegment,
		}, nil
	case "LineSegmentList":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.LineSegmentList, proto_seven_robotics_msgs.LineSegmentList]{
			MsgConverter: ConvertLineSegmentList,
			Serializer:   SerializeLineSegmentList,
		}, nil
	case "PowerStatus":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.PowerStatus, proto_seven_robotics_msgs.PowerStatus]{
			MsgConverter: ConvertPowerStatus,
			Serializer:   SerializePowerStatus,
		}, nil
	case "AdisImu":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.AdisImu, proto_seven_robotics_msgs.AdisImu]{
			MsgConverter: ConvertAdisImu,
			Serializer:   SerializeAdisImu,
		}, nil
	case "BatteryType":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.BatteryType, proto_seven_robotics_msgs.BatteryType]{
			MsgConverter: ConvertBatteryType,
			Serializer:   SerializeBatteryType,
		}, nil
	case "PowerManagement":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.PowerManagement, proto_seven_robotics_msgs.PowerManagement]{
			MsgConverter: ConvertPowerManagement,
			Serializer:   SerializePowerManagement,
		}, nil
	case "Battery":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.Battery, proto_seven_robotics_msgs.Battery]{
			MsgConverter: ConvertBattery,
			Serializer:   SerializeBattery,
		}, nil
	case "ObstacleRadius":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.ObstacleRadius, proto_seven_robotics_msgs.ObstacleRadius]{
			MsgConverter: ConvertObstacleRadius,
			Serializer:   SerializeObstacleRadius,
		}, nil
	case "RPMError":
		return &channel.BuilderUtil[gengo_seven_robotics_msgs.RPMError, proto_seven_robotics_msgs.RPMError]{
			MsgConverter: ConvertRPMError,
			Serializer:   SerializeRPMError,
		}, nil
	case "Extrinsics":
