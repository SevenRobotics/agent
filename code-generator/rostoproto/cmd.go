...
func NewGen() *GeneratorUtil {
	...
	blacklist := []string{"turtlesim", "tf","seven_robotics_msgs","object_recognition_msgs","geographic_msgs","rosserial_msgs","foxglove_msgs","aruco_msgs","seven_robot_perception","rtabmap_ros","nav_msgs","obstacle_detector","mask_rcnn_ros","costmap_2d","sick_scan","apriltag_ros","teb_local_planner","costmap_converter","control_msgs","gazebo_msgs","ar_track_alvar_msgs","graph_msgs","map_msgs","move_base_msgs","octomap_msgs","pcl_msgs","people_msgs","shape_msgs","stereo_msgs","tf2_msgs","trajectory_msgs","turtlebot3_example","visualization_msgs"}
